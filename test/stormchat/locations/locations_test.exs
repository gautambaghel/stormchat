defmodule Stormchat.LocationsTest do
  ...
  describe "locations" do
    ...
    @valid_attrs %{abb: "some abb", name: "some name", pid: "some pid"}
    @update_attrs %{abb: "some updated abb", name: "some updated name", pid: "some updated pid"}
    @invalid_attrs %{abb: nil, name: nil, pid: nil}
    ...
    test "create_location/1 with valid data creates a location" do
      ...
      assert location.abb == "some abb"
      assert location.name == "some name"
      assert location.pid == "some pid"
    end
    ...
    test "update_location/2 with valid data updates the location" do
      ...
      assert location.abb == "some updated abb"
      assert location.name == "some updated name"
      assert location.pid == "some updated pid"
    end
