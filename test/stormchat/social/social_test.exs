defmodule Stormchat.SocialTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{alert: "some alert", body: "some body"}
    @update_attrs %{alert: "some updated alert", body: "some updated body"}
    @invalid_attrs %{alert: nil, body: nil}
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert %Post{} = post
      assert post.alert == "some updated alert"
